                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Create New Reports</div>
                            <div class="panel-body">
                                ...
                                <form method="POST" action="/Reports/store" class="form-horizontal">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" name="clients_id" type="text" id="clients_id" value="{{old('clients_id')}}">
                                        </div>
                                    </div>
										<div class="form-group">
                                        <label for="job_id" class="col-md-4 control-label">job_id: </label>
                                        <div class="col-md-6">
                                            <input class="form-control" name="job_id" type="text" id="job_id" value="{{old('job_id')}}">
                                        </div>
                                    </div>
