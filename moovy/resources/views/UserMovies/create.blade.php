                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Create New UserMovies</div>
                            <div class="panel-body">
                                ...
                                <form method="POST" action="/UserMovies/store" class="form-horizontal">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" name="movie_title" type="text" id="movie_title" value="{{old('movie_title')}}">
                                        </div>
                                    </div>
										<div class="form-group">
