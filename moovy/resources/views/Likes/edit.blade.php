                        ...
                        <div class="panel panel-default">
                            ...
                            <form method="POST" action="/Likes/{{ $Likes->id }}" class="form-horizontal">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control" name="user_id" type="text" id="user_id" value="{{$Likes->user_id}}">
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="job_id" class="col-md-4 control-label">job_id: </label>
                                            <div class="col-md-6">
                                                <input class="form-control" name="job_id" type="text" id="job_id" value="{{$Likes->job_id}}">
                                            </div>
                                        </div>
